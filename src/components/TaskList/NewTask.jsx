...
const NewTask = () => {
  return (
    <div className="h-full w-[300px] flex-shrink-0 bg-gradient-to-br from-gray-800/70 to-gray-900/70 border border-white/10 rounded-2xl p-6 shadow-[0_4px_30px_rgba(0,0,0,0.2)] hover:shadow-[0_4px_40px_rgba(16,185,129,0.2)] hover:scale-[1.02] transition-all duration-300 backdrop-blur-md">
      {" "}
